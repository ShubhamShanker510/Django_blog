...
urlpatterns = [
    ...
    path('dashboard/create-blog/', dashboard_create_blog, name='dashboard_create_blog'),
    path('dashboard/edit-user/<int:userid>/', edit_user, name='edit_user'),
    path('dashboard/delete-user/<int:userid>/', delete_user, name='delete_user'),
    path('dashboard/edit-post/<int:postid>/', dashboard_edit_blog, name='edit_post'),
